"""
WebSocket endpoints for HRAgents SDK.
...
from runtime.server.bash_service import (
    BashEventService,
    get_default_bash_event_service,
)
from runtime.server.config import Config, get_default_config
from runtime.server.conversation_service import (
    ConversationService,
    CredentialBindingActivationRequired,
    get_default_conversation_service,
)
from utilities.pii_redact import redact_pii_deep
from runtime.server.event_router import normalize_datetime_to_server_timezone
...
from runtime.server.pub_sub import MaxSubscribersError, Subscriber
from core.execution.event import Event
from models.llm import Message
from utilities.paging import page_iterator
...
async def _send_event(event: Event, websocket: WebSocket):
    ...
    try:
        ...
        # Strip SSN/phone/email/etc. before the frame leaves the server.
        await websocket.send_json(redact_pii_deep(dumped))
