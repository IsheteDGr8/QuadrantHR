...
export const intakeClusters: IntakeCluster[] = [
  ...
  },
  {
    ...
    label: "Copilot · needs your action",
    domain: "Copilot",
    discovered: false,
    blurb:
      "Live agent runs waiting on your approval (send email, write records, confirm packets).",
    trend: [0, 0, 0, 1, 1, 2, 2],
  },
  {
    id: "uncategorised",
    ...
    domain: "General",
    discovered: false,
    blurb: "Intake that has not been clustered yet.",
    trend: [1, 1, 1, 1, 1, 1, 1],
  },
];
