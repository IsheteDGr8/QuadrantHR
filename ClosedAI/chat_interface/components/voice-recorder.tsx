...
export function VoiceRecorder({ onCancel, onConfirm, barCount = 60 }: VoiceRecorderProps) {
  ...
  return (
    <div className="dream-pop mb-3 rounded-full border border-border bg-background px-6 py-3">
      <div className="flex items-center justify-between gap-6">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <Button
            ...
            className="btn-3d btn-glow h-8 w-8 rounded-full bg-primary text-primary-foreground shadow-sm hover:bg-primary/90"
